...
exports.getSnapshotWhere = exports.readDataWhere = exports.deleteData = exports.readDataNoCache = exports.readData = exports.addData = void 0;
...
var readDataNoCache = function (collection, document) { return __awaiter(void 0, void 0, void 0, function () {
    var doc, data, snapshots, res_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (!!!document) return [3 /*break*/, 2];
            ...
            case 3:
                snapshots = _a.sent();
                res_2 = [];
                snapshots.forEach(function (snapshot) { return res_2.push(snapshot.data()); });
                return [2 /*return*/, res_2];
        }
    });
}); };
exports.readDataNoCache = readDataNoCache;
...
var getSnapshotWhere = function (collection, fieldPath, opStr, value) { return Firebase_1.db.collection(collection).where(fieldPath, opStr, value); };
exports.getSnapshotWhere = getSnapshotWhere;
var collectionAndDocumentToId = function (collection, document) { return "".concat(collection, "/").concat(document); };
